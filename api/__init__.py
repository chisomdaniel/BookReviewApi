...
from api.user_api import Login, Signup, Profile, Users
#from app import app
...
api.add_resource(Profile, '/api/me', strict_slashes=False)
api.add_resource(Users, '/api/users', '/api/user/<int:user_id>', strict_slashes=False)
